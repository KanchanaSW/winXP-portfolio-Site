...
export function ResumeWindow() {
  ...
  return (
    <div className="flex flex-col h-full min-h-[320px] p-3 text-[11px]">
      <p className="font-bold mb-2">Open</p>
      <div className="flex gap-4 flex-1 min-h-0">
        <div className="w-28 flex flex-col items-center p-2 xp-bevel-inset bg-white">
          <DocumentIcon size={48} />
          <span className="mt-2 text-center">Resume.pdf</span>
        </div>
        <div className="flex-1 xp-bevel-inset bg-white p-3 overflow-auto xp-scrollbar">
